...
public class BuscaMinas {
     ...
     * 
     * @param dificultad El nivel de dificultad: 'P' para Principiante(8x8 y 10
     *                   minas), 'I' para Intermedio(16x16 y 40 minas), 'E' para
     *                   Experto(31x16 y 99 minas).
     */
     ...
     */
    public char[][] getMapa() {
        char[][] copiaMapa = new char[mapa.length][];
        for (int i = 0; i < mapa.length; i++) {
            copiaMapa[i] = mapa[i].clone();
        }
        return copiaMapa;
    }
    ...
    public char[][] getMapaBlanco() {
        char[][] copiaMapaBlanco = new char[mapaBlanco.length][];
        for (int i = 0; i < mapaBlanco.length; i++) {
            copiaMapaBlanco[i] = mapaBlanco[i].clone();
        }
    ...
    /**
     * Coloca los números que indican la cantidad de minas adyacentes a cada casilla
     * vacía.
     */
    ...
    /**
     * Descubre una casilla del tablero, revelando si hay una mina o el número de
     * minas adyacentes.
     * 
    ...
    /**
     * Coloca los números en el tablero que indican la cantidad de minas adyacentes
     * a cada casilla vacía.
     */
     ...
     * 
     * @return Verdadero si todas las minas están correctamente marcadas con
     *         banderas, falso en caso contrario.
     */
